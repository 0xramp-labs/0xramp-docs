...
<Steps>
  ...
  <Step title="Pay via Fiat">
    A Fiat QR code is displayed in the app (for example, Pix). Scan or copy it and complete the payment from your bank app for the exact amount shown. The fiat address belongs to a P2P.me merchant. 0xramp never handles your payment credentials.
  </Step>
